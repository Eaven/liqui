...
This class wraps the Trade API calls for Liqui. Parameters are passed to the method as a hashmap. More information on parameters can be found on the API docs here https://wex.nz/api/documentation
